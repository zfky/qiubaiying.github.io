...
这个README我直接拿[BY](https://github.com/Huxpro/huxpro.github.io)的来修改了。😅

### [我的博客在这里 &rarr;](http://zfky.github.io)

![](https://raw.githubusercontent.com/zfky/zfky.github.io/master/img/readme-home.png)
...
看右边:
![](https://raw.githubusercontent.com/zfky/zfky.github.io/master/img/readme-side.png)
...
我的博客标题是 **“ZFKY Blog”** 但是我想要在搜索的时候显示 **“zfky的博客 | ZFKY Blog”** ，这个就需要SEO Title来定义了。
...
1. 这个模板是从这里[BY](https://github.com/Huxpro/huxpro.github.io)fork 的。感谢这个作者 
